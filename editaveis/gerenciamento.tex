...
Esse tópico irá abordar apenas a rastreabilidade de requisitos do SAFe que será utilizado no projeto. Tendo como referência, a \textit{The big picture of agile requirements}, por Dean Leffingwell, os temas associados a requisitos, se dividem, por fases:
...
Fase responsável pela auto-organização de times ágeis, entrega contínua de valor, visão do produto, criação de Features por meio dos épicos encontrados, identificação dos requisitos não-funcionais do projeto e elaboração de um Roadmap do projeto, ou seja, um roteiro ou cronograma para planejar o futuro do projeto.
